...
export const PromptInput: React.FC<PromptInputProps> = ({ prompt, setPrompt, onSubmit, isLoading, mode, isSubmitDisabled, apiKeySet }) => {
    ...
    const getButtonContent = () => {
        ...
        const text = !apiKeySet ? 'API 키 설정 필요' : (mode === AppMode.Generate ? '생성하기' : '편집하기');
